...
def Contact(request):
    ...
    if request.method == "POST":
        ...
        contact_form = ContactUs(firstname=firstname, lastname=lastname,
                                 email=email, forms_need=needs, de_message=de_message)
        contact_form.save()
        messages.success(
            request, "Your messages has been sent successfully our representative will reach out to you in a short time 😎")
